...
CMD curl https://raw.githubusercontent.com/Canaan-Media/icecast2/master/icecast2.xml --output /etc/icecast2/icecast.xml && chmod -R a+rw /var/log/icecast2 && /etc/init.d/icecast2 start && tail -F /var/log/icecast2/error.log
