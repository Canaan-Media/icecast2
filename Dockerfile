...
CMD curl https://raw.githubusercontent.com/Canaan-Media/icecast2/master/icecast2.xml?token=GHSAT0AAAAAAB56FU6V2IKC7P6PN7OMDK5KY6SAKAA --output /etc/icecast2/icecast.xml && chmod -R a+rw /var/log/icecast2 && /etc/init.d/icecast2 start && tail -F /var/log/icecast2/error.log
